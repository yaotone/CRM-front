...
export default function SpecialInfo({date, gender, setDate, setGender, dateToChage, genderToChange, onlyDate}){
    ...
    return(
        <div className='specialInfo_container'>
            {!onlyDate && <div className='specialInfo_gender'>
                ...
                <div className='specialInfo_gender_input_container' onClick={handleUnfold}>
                    ...
                    {top: `38px`, opacity: `1`, visibility: `visible`}}
                    ref={dropdown}>
            ...
            <div className='specialInfo_birth'>
                ...
                <input type='date' className='specialInfo_birth_input' value={date} max={new Date().toISOString().split("T")[0]}
